...
| `environment/observation.py` | Immutable raw post-execution observation evidence with explicit observed/unknown/unavailable states, append-only journaling, and the elementary observer-independence predicate. | Code | Work | #35 |
